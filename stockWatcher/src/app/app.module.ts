...
import { NasdaqPage} from '.././pages/nasdaq/nasdaq'; 
import { SandPPage } from '.././pages/sand-p/sand-p';
import { DowJonesPage} from '.././pages/dow-jones/dow-jones';
import { NysePage} from '.././pages/nyse/nyse';
...
@NgModule({
  ...
  imports: [
    BrowserModule, HttpClientModule, AngularFireAuthModule, AngularFireDatabaseModule,
